import { IAuthor, IItems, IKanbanBoard } from '@/shared/types';
...
const getByAuthor = (author: IAuthor, items: IItems) =>
...
export const generateQuoteMap = (quoteCount: number): IKanbanBoard =>
  authors.reduce(
    (previous, author) => ({
      ...previous,
